...
.. _softwareBundleImport-get:

softwareBundleImport_get
------------------------

.. function:: GET /users/{uid}/bundleimports/{sbid}
...
This object is created automatically when a request to import a ``software bundle archive`` is sent to the platform. See :ref:`softwarebundle-import` for more information.
