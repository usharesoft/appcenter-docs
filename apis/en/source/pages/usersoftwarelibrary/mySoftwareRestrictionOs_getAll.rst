...
.. function:: GET /users/{uid}/mysoftware/{msid}/restrictions/{brid}/distributions
...
.. code-block:: bash
	...
	curl "https://uforge.example.com/api/users/{uid}/mysoftware/{msid}/restrictions/{brid}/distributions" -X GET \
