...
.. _workspaceTemplate-vote:

workspaceTemplate_vote
----------------------

.. function:: POST /orgs/{oid}/workspaces/{wid}/templates/{tid}/vote
...
.. code-block:: bash
	...
	curl "http://www.example.com/api/orgs/{oid}/workspaces/{wid}/templates/{tid}/vote" -X POST \
