...
.. note:: The LVM VolGroup Name name should be unique. The default when installing UForge will have a format similar to ``vg_uss_150910-lv_uss_150910``. If your scanned instance have the same volume group name, or if you set up advanced partitioning with the same name, you will get an error when migrating.
