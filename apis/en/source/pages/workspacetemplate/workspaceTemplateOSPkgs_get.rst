...
.. _workspaceTemplateOSPkgs-get:

workspaceTemplateOSPkgs_get
---------------------------

.. function:: GET /orgs/{oid}/workspaces/{wid}/templates/{tid}/osprofile/{ospid}/pkgs
...
.. code-block:: bash
	...
	curl "/orgs/{oid}/workspaces/{wid}/templates/{tid}/osprofile/{ospid}/pkgs" -X GET \
