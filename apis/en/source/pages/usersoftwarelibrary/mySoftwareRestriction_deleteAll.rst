...
.. _mySoftwareRestriction-deleteAll:

mySoftwareRestriction_deleteAll
-------------------------------

.. function:: DELETE /users/{uid}/mysoftware/{msid}/restrictions
...
Removes all the bundle restrictions for a software component.
...
.. code-block:: bash
	...
	curl "https://uforge.example.com/api/users/{uid}/mysoftware/{msid}/restrictions" -X DELETE \
