...
.. _projectRestriction-deleteAll:

projectRestriction_deleteAll
----------------------------

.. function:: DELETE /orgs/{oid}/projects/{pid}/restrictions
...
Removes all the bundle restrictions for a project.
...
.. code-block:: bash
	...
	curl "https://uforge.example.com/api/orgs/{oid}/projects/{pid}/restrictions" -X DELETE \
