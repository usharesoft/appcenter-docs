...
Before you create a Golden Image from scan, you must have access to a machine with the version of Windows you want to scan installed. For more information on supported versions refer to :ref:`windows-versions`.
