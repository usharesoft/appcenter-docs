...
.. note:: When generating a CentOS 7 Docker image from software components, only minimal packages will be included. For example, the kernel will not be included. This will result in a light-weight image.
