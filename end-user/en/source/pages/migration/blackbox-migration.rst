...
When you carry out black box migration (by generating a machine image directly from a scan), the following steps are carried out:
	...
	1. You are prompted to indicate if you wish to change the overall disk size.
