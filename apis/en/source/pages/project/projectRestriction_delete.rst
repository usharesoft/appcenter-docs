...
.. _projectRestriction-delete:

projectRestriction_delete
-------------------------

.. function:: DELETE /orgs/{oid}/projects/{pid}/restrictions/{brid}
...
Removes a bundle restriction for a project.
...
.. code-block:: bash
	...
	curl "https://uforge.example.com/api/orgs/{oid}/projects/{pid}/restrictions/{brid}" -X DELETE \
