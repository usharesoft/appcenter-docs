...
.. _mySoftwareOs-getAll:

mySoftwareOs_getAll
-------------------

.. function:: GET /users/{uid}/mysoftware/{msid}/distributions
...
Retrieves all the distributions where a software component can be used. 
...
.. code-block:: bash
	...
	curl "https://uforge.example.com/api/users/{uid}/mysoftware/{msid}/distributions" -X GET \
