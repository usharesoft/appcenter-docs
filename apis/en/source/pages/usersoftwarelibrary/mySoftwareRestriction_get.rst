...
.. _mySoftwareRestriction-get:

mySoftwareRestriction_get
-------------------------

.. function:: GET /users/{uid}/mysoftware/{msid}/restrictions/{brid}
...
Retrieves a bundle restriction for a software component.
...
.. code-block:: bash
	...
	curl "https://uforge.example.com/api/users/{uid}/mysoftware/{msid}/restrictions/{brid}" -X GET \
